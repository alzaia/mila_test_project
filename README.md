...
This is a test for the mila cookiecutter pipeline.
...
We suggest to also look at the GitHub project page for more up-to-date info)
    ...
    git remote add origin git@github.com:alzaia/mila_test_project.git
    git branch -M main
...
clone your project:
    ...
    git clone git@github.com:alzaia/mila_test_project.git

Then activate your virtual env, and install the dependencies:

    cd mila_test_project
    pip install -e .
